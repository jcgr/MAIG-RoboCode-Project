namespace MAIG_RoboCode_Project.GameObjects
{
    ...
    /// <summary>
    /// A gamestate in the Monte-Carlo Tree Search algorithm for Robocode.
    /// </summary>
    public class Gamestate
    {
        ...
        /// <param name="ri">The instructions used to arrive at this gamestate.</param>
        ...
        /// <summary>
        /// Gets the instructions for the MCTS robot used to arrive at this gamestate from the previous gamestate.
        /// </summary>
        ...
        /// </summary>
        /// <param name="gs"> The gamestate to simulate from.</param>
